            ...
            <div class="content-wrapper">
                <section class="content-header">
                    <h1>
                        ...
                        ?>
                        <small><button type="button" class="btn btn-block btn-primary btnNew" data-toggle="modal" data-target="#modalNew">NEW</button></small>
                    </h1>
                </section>
                                                            ...
                                                            <?php
                                                                if ($result_state === NULL) {
                                                                    foreach ($fields as $field) {                                                                  
                                                                        echo '<th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="" style="width: auto;">' . $field['Tables_in_db_master'] . '</th>';
                                                                    }
                                                                } else {
        ...
        <script>
            $( document ).ready(function() {
                ...
                $('.btnNew').click(function() {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'ajax/newGetForm.php',
                        datatype: 'json' ,
                        data: {
                            table: table
                        },
                        success: function (data) {
                            $("#modalNewForm").append(data);
                        }
                    });
                });
